    ...
    <div className="h-[90vh] flex items-center justify-center bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-500 px-6">
      <div className="max-w-4xl bg-white dark:bg-zinc-900 shadow-xl rounded-2xl p-8 md:p-12">
        ...
        <p className="text-gray-600 dark:text-gray-300 text-lg leading-relaxed text-center">
             Order Magicis a global tech giant known for its massive e-commerce platform,
        ...
        <p className="mt-4 text-gray-600 dark:text-gray-300 text-lg leading-relaxed text-center">
          ...
          bookstore, Order Magic evolved into <span className="italic">“The Everything Store”</span>.
        ...
        <p className="mt-4 text-gray-600 dark:text-gray-300 text-lg leading-relaxed text-center">
             Order Magic continues to innovate by expanding into satellite internet
